    ...
    <div class="py-12 md:py-20">
      <div class="max-w-3xl mx-auto px-4">
        ...
        <div v-else-if="page" class="prose">
          ...
          <div class="flex items-center gap-4 text-sm text-zinc-500 mb-12">
        ...
        <div v-else class="text-center py-12">
          <h1 class="text-4xl sm:text-5xl font-black mb-6 leading-tight">
            <span class="text-zinc-900">404</span>
          </h1>
          <p class="text-zinc-600 mb-8">Page not found</p>
          <NuxtLink to="/" class="bg-zinc-900 hover:bg-lime-500 text-white hover:text-zinc-900 font-medium px-6 py-2.5 min-w-[140px] text-center rounded-full transition-colors text-sm shadow focus:outline-none focus:ring-2 focus:ring-lime-500">
            Back to Home
          </NuxtLink>
        </div>
      </div>
